...
(function ($) {
    ...
    var $document = $(document),
        ie8detected = (AJS.$.browser.msie && parseInt(AJS.$.browser.version, 10) == 8);
    ...
    var DROPDOWN_TRIGGER = {
        "aui-button-invoke": function (event, options) {
            ...
            if (ie8detected) {
                $dropdown.removeClass('aui-dropdown2-tailed');
            }
            ...
            function setPosition() {
                ...
                if (ie8detected) {
                    horizontalBorderWidth = parseInt($dropdown.css("border-left-width"), 10) + parseInt($dropdown.css("border-right-width"), 10);
...
(function($) {
    ...
    AJS.InlineDialog = function (items, identifier, url, options) {
        ...
        popup.show = function (e, trigger) {
            ...
            appendPopup();
            if (options.noBind && !(items && items.length)) {
    ...
    function calculateWestPositions(popup, targetPosition, mousePosition, opts) {
        ...
        var arrowCss = {
            top: halfPopupHeight - halfArrowHeight + arrow.offset.top + adjustmentForOverflow
        };
...
AJS.dropDown = function (obj, usroptions) {
    ...
    dd.each(function () {
      ...
      // shim to sit over flash and select boxes in IE8 and down.
