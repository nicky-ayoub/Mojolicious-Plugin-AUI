...
aui.dialog.dialog2 = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param219 = new soy.StringBuilder();
  aui.dialog.dialog2Content(opt_data, param219, opt_ijData);
  aui.dialog.dialog2Chrome({id: opt_data.id, titleId: opt_data.id ? opt_data.id + '-dialog-title' : null, modal: opt_data.modal, tagName: opt_data.tagName, removeOnHide: opt_data.removeOnHide, visible: opt_data.visible, size: opt_data.size, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param219.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.expander.revealText = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param596 = new soy.StringBuilder(soy.$$escapeHtml(opt_data.contentContent));
  aui.expander.trigger({id: opt_data.triggerId, contentId: opt_data.contentId, tag: 'a', content: '<span class=\'reveal-text-trigger-text\'>Show more</span>', replaceSelector: '.reveal-text-trigger-text', replaceText: 'Show less', extraAttributes: opt_data.triggerExtraAttributes, extraClasses: ((opt_data.triggerExtraClasses) ? soy.$$escapeHtml(opt_data.triggerExtraClasses) + '  ' : '') + ' aui-expander-reveal-text'}, param596, opt_ijData);
  aui.expander.content({id: opt_data.contentId, content: param596.toString(), extraAttributes: opt_data.contentExtraAttributes, extraClasses: opt_data.contentExtraClasses}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.fieldset = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var hasClass__soy666 = opt_data.isInline || opt_data.isDateSelect || opt_data.isGroup || opt_data.extraClasses;
...
aui.form.renderValidationArguments = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.validationArguments) {
    var argumentList804 = soy.$$getMapKeys(opt_data.validationArguments);
    var argumentListLen804 = argumentList804.length;
    for (var argumentIndex804 = 0; argumentIndex804 < argumentListLen804; argumentIndex804++) {
      var argumentData804 = argumentList804[argumentIndex804];
      output.append('data-aui-validate-', soy.$$escapeHtml(argumentData804), '="', soy.$$escapeHtml(opt_data.validationArguments[argumentData804]), '"');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.form.renderTooltipArguments = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.tooltipArguments) {
    var argumentList814 = soy.$$getMapKeys(opt_data.tooltipArguments);
    var argumentListLen814 = argumentList814.length;
    for (var argumentIndex814 = 0; argumentIndex814 < argumentListLen814; argumentIndex814++) {
      var argumentData814 = argumentList814[argumentIndex814];
      output.append('data-aui-form-notification-', soy.$$escapeHtml(argumentData814), '="', soy.$$escapeHtml(opt_data.tooltipArguments[argumentData814]), '"');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.form.submit = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param836 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param836, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: 'input', inputType: 'submit', text: opt_data.text, type: opt_data.type, href: opt_data.href, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: opt_data.extraClasses, extraAttributes: param836.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.button = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param860 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param860, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: opt_data.tagName, inputType: opt_data.inputType, text: opt_data.text, type: opt_data.type, href: opt_data.href, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: opt_data.extraClasses, extraAttributes: param860.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.linkButton = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param883 = new soy.StringBuilder('cancel');
  aui.renderExtraClasses(opt_data, param883, opt_ijData);
  var param887 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param887, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: 'a', inputType: opt_data.inputType, text: opt_data.text, type: 'link', href: opt_data.href ? opt_data.href : opt_data.url, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: param883.toString(), extraAttributes: param887.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.select = function(opt_data, opt_sb, opt_ijData) {
  ...
  aui.form.renderTooltipArguments(opt_data, output, opt_ijData);
  output.append('>');
  var optionList986 = opt_data.options;
  var optionListLen986 = optionList986.length;
  for (var optionIndex986 = 0; optionIndex986 < optionListLen986; optionIndex986++) {
    var optionData986 = optionList986[optionIndex986];
    aui.form.optionOrOptgroup(soy.$$augmentData(optionData986, {defaultValue: opt_data.value}), output, opt_ijData);
  }
...
aui.form.optionOrOptgroup = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.options) {
    ...
    var optionList997 = opt_data.options;
    var optionListLen997 = optionList997.length;
    for (var optionIndex997 = 0; optionIndex997 < optionListLen997; optionIndex997++) {
      var optionData997 = optionList997[optionIndex997];
      aui.form.optionOrOptgroup(soy.$$augmentData(optionData997, {defaultValue: opt_data.defaultValue}), output, opt_ijData);
    }
    output.append('</optgroup>');
  } else {
    output.append('<option value="', soy.$$escapeHtml(opt_data.value), '"', (opt_data.selected || opt_data.defaultValue == opt_data.value) ? ' selected' : '', '>', soy.$$escapeHtml(opt_data.text), '</option>');
  }
  return opt_sb ? '' : output.toString();
};
...
aui.form.field = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var isCheckboxOrRadio__soy1028 = opt_data.type == 'checkbox' || opt_data.type == 'radio';
  var fieldWidthClass__soy1029 = opt_data.fieldWidth ? opt_data.fieldWidth + '-field' : '';
  output.append('<div class="', (isCheckboxOrRadio__soy1028) ? soy.$$escapeHtml(opt_data.type) : 'field-group');
  aui.renderExtraClasses(opt_data, output, opt_ijData);
  output.append('"');
  aui.renderExtraAttributes(opt_data, output, opt_ijData);
  output.append('>');
  if (opt_data.labelContent && ! isCheckboxOrRadio__soy1028) {
    aui.form.label({forField: opt_data.id, isRequired: opt_data.isRequired, content: opt_data.labelContent}, output, opt_ijData);
  }
  switch (opt_data.type) {
    case 'textarea':
      aui.form.textarea({id: opt_data.id, name: opt_data.name, value: opt_data.value, rows: opt_data.rows, cols: opt_data.cols, autocomplete: opt_data.autocomplete, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1029, icon: opt_data.icon, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
    case 'select':
      aui.form.select({id: opt_data.id, name: opt_data.name, value: opt_data.value, options: opt_data.options, isMultiple: opt_data.isMultiple, size: opt_data.size, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1029, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
    case 'value':
    ...
    case 'submit':
    case 'reset':
      aui.form.input({id: opt_data.id, name: opt_data.name, type: opt_data.type, value: opt_data.value, maxLength: opt_data.maxLength, size: opt_data.size, autocomplete: opt_data.autocomplete, isChecked: opt_data.isChecked, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1029, icon: opt_data.icon, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
  }
  if (opt_data.labelContent && isCheckboxOrRadio__soy1028) {
    aui.form.label({forField: opt_data.id, isRequired: opt_data.isRequired, content: opt_data.labelContent}, output, opt_ijData);
  ...
  if (opt_data.errorTexts) {
    var errorList1109 = opt_data.errorTexts;
    var errorListLen1109 = errorList1109.length;
    for (var errorIndex1109 = 0; errorIndex1109 < errorListLen1109; errorIndex1109++) {
      var errorData1109 = errorList1109[errorIndex1109];
      aui.form.fieldError({message: errorData1109}, output, opt_ijData);
    }
  }
  output.append('</div>');
  return opt_sb ? '' : output.toString();
...
aui.form.checkboxField = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param1238 = new soy.StringBuilder((opt_data.isMatrix) ? '<div class="matrix">' : '');
  var fieldList1242 = opt_data.fields;
  var fieldListLen1242 = fieldList1242.length;
  for (var fieldIndex1242 = 0; fieldIndex1242 < fieldListLen1242; fieldIndex1242++) {
    var fieldData1242 = fieldList1242[fieldIndex1242];
    aui.form.field(soy.$$augmentData(fieldData1242, {type: 'checkbox', labelContent: soy.$$escapeHtml(fieldData1242.labelText)}), param1238, opt_ijData);
  }
  param1238.append((opt_data.isMatrix) ? '</div>' : '');
  if (opt_data.descriptionText || opt_data.descriptionContent || opt_data.errorTexts && opt_data.errorTexts.length) {
    aui.form.field({descriptionText: opt_data.descriptionText, descriptionContent: opt_data.descriptionContent, errorTexts: opt_data.errorTexts, isDisabled: false}, param1238, opt_ijData);
  }
  aui.form.fieldset({legendContent: opt_data.legendContent + (opt_data.isRequired ? '<span class="aui-icon icon-required"></span>' : ''), isGroup: true, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param1238.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.radioField = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param1265 = new soy.StringBuilder((opt_data.isMatrix) ? '<div class="matrix">' : '');
  var fieldList1269 = opt_data.fields;
  var fieldListLen1269 = fieldList1269.length;
  for (var fieldIndex1269 = 0; fieldIndex1269 < fieldListLen1269; fieldIndex1269++) {
    var fieldData1269 = fieldList1269[fieldIndex1269];
    aui.form.field(soy.$$augmentData(fieldData1269, {type: 'radio', name: opt_data.name ? opt_data.name : opt_data.id, labelContent: soy.$$escapeHtml(fieldData1269.labelText)}), param1265, opt_ijData);
  }
  param1265.append((opt_data.isMatrix) ? '</div>' : '');
  if (opt_data.descriptionText || opt_data.descriptionContent || opt_data.errorTexts && opt_data.errorTexts.length) {
    aui.form.field({descriptionText: opt_data.descriptionText, descriptionContent: opt_data.descriptionContent, errorTexts: opt_data.errorTexts, isDisabled: false}, param1265, opt_ijData);
  }
  aui.form.fieldset({legendContent: opt_data.legendContent + (opt_data.isRequired ? '<span class="aui-icon icon-required"></span>' : ''), isGroup: true, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param1265.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.progressTracker.progressTracker = function(opt_data, opt_sb, opt_ijData) {
  ...
  aui.renderExtraAttributes(opt_data, output, opt_ijData);
  output.append('>');
  var param1816 = new soy.StringBuilder();
  var currentStepList1817 = opt_data.steps;
  var currentStepListLen1817 = currentStepList1817.length;
  for (var currentStepIndex1817 = 0; currentStepIndex1817 < currentStepListLen1817; currentStepIndex1817++) {
    var currentStepData1817 = currentStepList1817[currentStepIndex1817];
    if (currentStepData1817['isCurrent']) {
      var stepList1820 = opt_data.steps;
      var stepListLen1820 = stepList1820.length;
      for (var stepIndex1820 = 0; stepIndex1820 < stepListLen1820; stepIndex1820++) {
        var stepData1820 = stepList1820[stepIndex1820];
        aui.progressTracker.step(soy.$$augmentData(stepData1820, {width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: stepIndex1820 < currentStepIndex1817 ? stepData1820['href'] : null}), param1816, opt_ijData);
      }
    }
  }
  aui.progressTracker.content({steps: opt_data.steps, content: param1816.toString()}, output, opt_ijData);
  output.append('</ol>');
  return opt_sb ? '' : output.toString();
};
...
aui.progressTracker.content = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.content != '') {
    ...
    var stepList1834 = opt_data.steps;
    var stepListLen1834 = stepList1834.length;
    for (var stepIndex1834 = 0; stepIndex1834 < stepListLen1834; stepIndex1834++) {
      var stepData1834 = stepList1834[stepIndex1834];
      aui.progressTracker.step(soy.$$augmentData(stepData1834, {isCurrent: stepIndex1834 == 0, width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: null}), output, opt_ijData);
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.tabs = function(opt_data, opt_sb, opt_ijData) {
  ...
  var itemList1930 = opt_data.menuItems;
  var itemListLen1930 = itemList1930.length;
  for (var itemIndex1930 = 0; itemIndex1930 < itemListLen1930; itemIndex1930++) {
    var itemData1930 = itemList1930[itemIndex1930];
    aui.tabMenuItem(itemData1930, output, opt_ijData);
  }
...
aui.toolbar.button = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (! (opt_data != null)) {
    ...
    var param2085 = new soy.StringBuilder();
    aui.toolbar.trigger({url: opt_data.url, title: opt_data.title, content: ((opt_data.iconClass) ? '<span class="icon ' + soy.$$escapeHtml(opt_data.iconClass) + '"></span>' : '') + ((opt_data.text) ? '<span class="trigger-text">' + soy.$$escapeHtml(opt_data.text) + '</span>' : '')}, param2085, opt_ijData);
    aui.toolbar.item({isActive: opt_data.isActive, isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param2085.toString()}, output, opt_ijData);
  }
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.link = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2103 = new soy.StringBuilder('toolbar-item-link');
  aui.renderExtraClasses(opt_data, param2103, opt_ijData);
  var param2107 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2107, opt_ijData);
  aui.toolbar.item({id: opt_data.id, extraClasses: param2103.toString(), extraAttributes: opt_data.extraAttributes, content: param2107.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.dropdownInternal = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2116 = new soy.StringBuilder(opt_data.itemClass);
  aui.renderExtraClasses(opt_data, param2116, opt_ijData);
  var param2121 = new soy.StringBuilder((opt_data.splitButtonContent) ? opt_data.splitButtonContent : '');
  var param2126 = new soy.StringBuilder();
  aui.dropdown.trigger({extraClasses: 'toolbar-trigger', accessibilityText: opt_data.text}, param2126, opt_ijData);
  aui.dropdown.menu({content: opt_data.dropdownItemsContent}, param2126, opt_ijData);
  aui.dropdown.parent({content: param2126.toString()}, param2121, opt_ijData);
  aui.toolbar.item({isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: param2116.toString(), extraAttributes: opt_data.extraAttributes, content: param2121.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.splitButton = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2150 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2150, opt_ijData);
  aui.toolbar.dropdownInternal({isPrimary: opt_data.isPrimary, id: opt_data.id, itemClass: 'toolbar-splitbutton', extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, dropdownItemsContent: opt_data.dropdownItemsContent, splitButtonContent: param2150.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
